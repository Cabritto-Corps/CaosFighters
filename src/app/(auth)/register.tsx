...
export default function RegisterScreen() {
    ...
    const formValid = name && email && password && confirm && !emailError && !passwordError && !confirmError
    ...
    async function handleRegister() {
        ...
        try {
            ...
            if (result.success) {
                Alert.alert('Conta criada!', 'Bem-vindo à arena, guerreiro!', [
                    {
                        text: 'OK',
                ...
                Alert.alert('Erro ao criar conta', result.error || 'Não foi possível criar a conta. Tente novamente.')
            }
        } catch (e) {
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                    ...
                    >
                        ...
                        >
                            ...
                            <Text style={{ color: '#00FF88', fontSize: 16, fontWeight: '600' }}>Voltar à Arena</Text>
                        </Pressable>
                        ...
                        >
                            ...
                            <Pressable
                                ...
                                style={({ pressed }) => ({
                                    backgroundColor: !formValid || isLoading ? '#444' : '#00FF88',
                                    paddingVertical: 16,
                                    borderRadius: 20,
                                    alignItems: 'center',
                                    borderWidth: 2,
                                    borderColor: !formValid || isLoading ? '#666' : '#0099FF',
                                    shadowColor: !formValid || isLoading ? '#000' : '#00FF88',
                                    shadowOpacity: 0.5,
                                    shadowRadius: 15,
